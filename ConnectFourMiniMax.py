...
# Task: implement a four in a row game using the MINIMAX ALGORITHM in python ✅
# Grass Is Always Greener, Tosh Palmer
...
def miniMax(board, depth, maxPlayer):
    ...
    if maxPlayer:
        ...
        for col in validCols: 
            ...
            resultingScore = miniMax(boardCopy, depth-1, False)[1]
        ...
        for col in validCols: 
            ...
            resultingScore = miniMax(boardCopy, depth-1, True)[1]
    ...
    while gameOver == False:
        if playerTurn == 0:
            ...
            if isWinningMove(board, 1):
             ...
             column = miniMax(board, 4, True)[0] # For Professor : if you're playing and want a harder version increaes the middle variable
             if isValidCol(board, column):
                  row = nextOpenSpot(board, column)
